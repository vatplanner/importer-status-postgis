...
public class MemoryWatchdog {
    ...
    public void cleanUpAndCheck() {
        ...
        double percentIncreaseSinceFirstImport = //
            (double) memoryIncreaseSinceFirstImport
                / usedMemoryBeforeFirstImport
                * 100.0;
        ...
        // quit before we risk hitting an OOM situation due to permanent increase in
        // usage
